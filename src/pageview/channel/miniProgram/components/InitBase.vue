  ...
  <div>
    ...
    >
      ...
      <div class="bind-body clear">
        <div class="bind-row">
          <img
            src="../../../../assets/images/channel/has-mini-program.png"
            alt=""
          >
          <a :href="authUrl">
            <Button
        ...
        <div class="bind-row">
          <img
            src="../../../../assets/images/channel/no-mini-program.png"
            alt=""
          >
          <a
            href="https://mp.weixin.qq.com/cgi-bin/registermidpage?action=index"
            target="_blank"
          >
            <Button
              type="primary"
      ...
      <div class="bind-footer">
        <h4 style="font-size: 16px;margin-bottom: 36px;">
          常见问题
        </h4>
      ...
      >
        ...
        >
          <i
            style="float: left;position: relative;top: -5px;color: #F8D98F"
