...
--> 
<template>
  <div :style="{position:'absolute',left:left+'px',bottom:bottom+'px',background:'#fff',width:menuWidth?menuWidth+'px':width+'px'}">
    <CommDrag
...
<style lang="scss">
  #secondMenuBox{display: flex; flex-direction: column;}
</style>
<style lang="scss" scoped>
  .child-menu{
    ...
    &::after{
      ...
      height: 0; width: 0;
      position: absolute; left:calc(50% - 8px);bottom:-15px;
