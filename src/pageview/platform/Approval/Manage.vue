      ...
      >
        ...
        >
          ...
          <div v-if="row.status == 3">
            ...
            <div v-if="!row.isTradeDel">
              <Button
                v-if="row.approveTradeType == 1 || row.approveTradeType == 2 || row.approveTradeType == 3"
                style="border:none;"
                class="gray-dis"
              >
                编辑
	...
	methods:{
		...
		clickContent(row){
            ...
            //领券详情页
                ...
                let url = "/activity/coupon/detail?type="+'couponCenter' + '&couponContactId=' + row.tradeId;
                window.open(url, "_blank"); 
            //商品详情页
