    ...
    return [
            ...
            render: (h, params) => {
                return h("div", [
                    ...
                    h("div", {
                        ...
                        [
                            params.row.status === 1 ? h("router-link", {
                                props: {
                                    to: "/member/manage/details?id=" + params.row.id,
                                },
                                class: "color-text",
                            }, params.row.memberName || params.row.nickName) : (params.row.memberName || params.row.nickName),
                            (params.row.sex === "F" || params.row.sex === "M") ? h("Icon", {
                                props: {
        ...
        },
        {
            ...
            render: (h, params) => {
                return h("div",
                    [
                        params.row.memberPayCardsRelationRespList && params.row.memberPayCardsRelationRespList.length ? h('div', [
                                h('span', {
                                    style: {
                                        padding: "0 4px",
                                        color: "#756CEA",
        ...
        },
        {
            ...
            render: (h, params) => {
                return h("div",
                    params.row.status !== 2 ? [
                        this.pageAction.includes('addMark') ? h("span", {
                            class: "span-a mr-10", on: {
                                click: () => {
                        ...
                        h("Dropdown", {
                            ...
                            h("span", {
                                ...
                                [
                                    ...
                                    h("i", {class: "icon iconfont " + (this.moreIndex === params.index ? "iconDropdownUnfold" : "iconTreeFold")}),
                                ],
                            ),
                            h("DropdownMenu", {
                                    slot: "list"
                                ...
                                [
                                    this.pageAction.includes('showTiao') ? h("DropdownItem", {props: {name: "drop-status"}}, "账户状态调整") : ""
                                ])
                        ]),
                    ] : [
                ...
                return h("div",
                    [
                        h("div", [
                            ...
                            (params.row.sex === "M" || params.row.sex === "F") ? h("Icon", {
                                props: {
                                    type: params.row.sex === "F" ? "md-female" : "md-male",
                                    color: params.row.sex === "F" ? "#FF6B6A" : "#1990FF",
                                },
...
export function labelCol() {
    return [
        ...
        {
            title: "标签名称/编号1111111", render: (h, params) => {
                return h("div", [
                    h("p", params.row.name),
...
export const cloudColors = [
    "#FF9966", "#6666CC", "#CC9966", "#00CCFF", "#FF9900",
    "#FF6699", "#108EE9", "#009999", "#CC6633", "#FF9999",
    "#0099CC", "#CC9933", "#006699", "#CC66FF", "#6699FF",
    "#CC9999", "#FFCCCC", "#666666", "#990033", "#990099"
];
