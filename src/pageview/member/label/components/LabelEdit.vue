  ...
  <div class="label-edit">
    ...
    <div class="label-content">
      ...
      <div class="text-right">
        <Button @click="onCancelCreateLabel">
          取消
        </Button>
        <Button
...
export default {
    ...
    mounted() {
        this.labelData = JSON.parse(JSON.stringify({
            labelBaseTypeId: this.propData.labelType,
            ...defaultLabel
        }));
        // this.debugTwoLevel()
    ...
    methods: {
        getLabelGroupList() {
            this.$ajaxGet("/label-server/labelType/listSimple")
                .then(res => {
        ...
        onCreateLabel() {
            ...
            this.$ajaxPost("/label-server/label/create", postData)
                .then(res => {
                    if (res && res.code === 10000) {
                        this.$Message.success(labelBaseTypeId === 2 ? "成功" : "保存成功，计算结果更新将有几分钟延迟，请稍后刷新查看");
                        this.$emit("whatComponent", {type: "LabelList"});
                    }
