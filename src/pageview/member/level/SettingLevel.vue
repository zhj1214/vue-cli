      ...
      <Row class="func-card-container">
        ...
        >
          <div class="func-card">
            ...
            <div
              v-show="grade.modifyTime"
              class="update-time big-block-narrow"
            >
        ...
        >
          <div class="func-card">
            ...
            <div class="setting-icon">
              ...
              >
                <span
                  class="setting-growth"
                  @click="jumpGrowthSetting"
                >
                  <i
      ...
      >
        <div class="modal-content">
          ...
          <div class="btn-container huge-block-narrow">
            <Button
              class="text-narrow"
              @click="closeDisablePop"
            >
              取消
            </Button>
            <Button
              type="primary"
              @click="toggleLevelMode('close')"
            >
              确定
            </Button>
          </div>
      ...
      >
        <div class="modal-content">
          ...
          <div class="action-content">
            ...
            <div>
              ② 若等级规则发生变更，启用后新会员立即生效、<span class="color-text">老会员延迟生效</span>
          ...
          <div class="btn-container huge-block-narrow">
            <Button
              class="text-narrow"
              @click="closeEnablePop"
            >
              取消
            </Button>
            <Button
              type="primary"
              @click="toggleLevelMode('open')"
            >
              确定
            </Button>
          </div>
    ...
    export default {
        ...
        methods: {
            ...
            renderPage(data) {
                ...
                let showConfigRow = (gradeLevelRelationList.length < 10) && !this.activeLevelMode && this.isGroup
                if (showConfigRow) {
                    let lastRow = {
                        id: '-',
