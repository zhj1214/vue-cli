...
<template>
  <div class="createLayer">
    <h2 class="h2">
      <span
        @click="$emit('whatComponent', {type: 'LayerList'})"
      >
        <img
          :src="$backIcon"
          alt="←"
    ...
    <div class="create-page">
      ...
      <div class="footer-btn">
        <Button @click="onCancelSubmitLayer">
          取消
        </Button>
        <Button
          class="ml-10"
      ...
      <div v-if="selectLabelModalStatus">
        ...
        >
          <div>
            ...
            >
              ...
              >
                <Select
                  slot="prepend"
                  v-model="labelPageData.inputName"
                  style="width: 100px"
                >
                  <Option value="id">
                    标签编号
          ...
          <div slot="footer">
            <Button @click="cancelSelectLabel">
              取消
            </Button>
            <Button
              type="primary"
      ...
      <div v-if="removeLabelPop">
        ...
        >
          ...
          <div slot="footer">
            <Button @click="cancelRemoveLabel">
              取消
            </Button>
            <Button
              type="primary"
              @click="confirmRemoveLabel"
            >
              提交
            </Button>
          </div>
...
export default {
    ...
    data() {
        return {
            ...
            layerValid: {
                ...
                keywords: [{required: true, type: "array", message: "关键词个数不超过20个，总长度不超过400", trigger: "change"}],
    ...
    methods: {
        getLayerDetail(id) {
            this.$ajaxGet("/label-server/labelGroup/detail", {id})
                .then(res => {
