    ...
    <view class="loginView">
      <view class="login-btn-container">
        ...
        <button
          v-if="!agreeStatus"
          class="cover-one"
          @click="showAgreeToast"
        ></button>
        <button
          class="login-button-outline block-narrow"
          @click="jumpPhoneLogin"
        >
          手机短信验证码登录
        </button>
        <button
...
export default {
  ...
  onLoad() {
    ...
    let arr = app.globalData.iphoneInfo.system.split("OS ");
    console.log(
