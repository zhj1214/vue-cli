export default {
	...
	methods: {
		getLeftTree() {
			this.$ajaxGet('/user-server/platform/department/directParent/tree',{departmentId:localStorage.getItem('departmentId')})
				.then(res => {
		...
		renderContent(h, {node, data}) {
			return h('span',
				...
				[
					(data.type === '1' || data.type === '2') ? h('i', {class: 'icon iconfont iconShop'}) : '',
