    ...
    >
      ...
      >
        ...
        >
          ...
          <template v-else>
            <div class="picture-card-item-error">
              失败
            </div>
          </template>
          <div
              ...
              <div>
                <div class="upload-item-con">
                  <div class="upload-item-left">
                    ...
                    <div
                      class="upload-text upload-name"
                      @click="handleView(item)"
                    >
                      {{ item.name }}
                      <span
                        v-if="item.sizeFormat"
                        class="upload-item-size"
                      >
                        （{{ item.sizeFormat }}）
                      </span>
                    </div>
      ...
      >
        <i-col>
          <ImgCutter
            ...
            :box-width="
              imgWidth >= boxWidth ? imgWidth + 50 : boxWidth
            "
            :box-height="
              imgHeight >= boxHeight ? imgHeight + 100 : boxHeight
            "
            :cut-width="imgWidth"
...
export default {
    ...
    methods: {
        ...
        handleBeforeUpload(file) {
            const check =
                !this.max || this.$refs.upload.fileList.length < this.max;
            if (!check) {
                this.$Message["error"]({
                    background: true,
        ...
        handleRemove(file) {
            ...
            this.$refs.upload.fileList.splice(
                this.$refs.upload.fileList.findIndex(
