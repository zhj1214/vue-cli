  ...
  <div class="cancle_page">
    ...
    <div>
      ...
      >
        ...
        <div
          v-if="cancelObj.exchangeFlag ? true : goodList.length ? true :false"
          class="modal"
        >
          <FormItem
            label="自提详情："
            prop="exchangeCodeList"
          >
            <p
              v-show="goodList.length"
              style="line-height:22px;margin-top:6px;"
            >
              ...
              >
                ...
                >
                  ...
                  <div>
                    ...
                    <p>{{ cancelObj.productPrice?'￥'+cancelObj.productPrice+'+':'' }}{{ cancelObj.productScore?cancelObj.productScore+'积分':'' }}</p>
              ...
              >
                ...
                >
                  ...
                  <div>
                    ...
                    <p>{{ item.productPrice?'￥'+item.productPrice+'+':'' }}{{ item.productScore?item.productScore+'积分':'' }}</p>
  ...
  methods: {
    async loadModuleList() {
      const { data } = await this.$ajaxGet(
        serveAPI + "/api/exchange/scoreShop/exchangeSource"
      );
