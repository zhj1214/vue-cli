      ...
      >
        ...
        >
          <div>
            ...
            <p><label>商品类目：</label>{{ curGoods.goodsCategoryCompleteName || curGoods.categoryCompleteName || curGoods.goodsCategoryText || '-' }}</p>
            ...
            <div style="width:80%">
              ...
              <Row v-if="goodsType=='2'&&curGoods.createTime">
                <i-col
                  ...
                  style="text-align:left;font-size:12px;color:#9AA8B8"
                >
                  {{ "日期："+$format(curGoods.createTime[0])+"-"+$format(curGoods.createTime[1]) }}
                </i-col>
              </Row>
            </div>
          </div>
